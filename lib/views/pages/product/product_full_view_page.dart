                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              Obx(() => Wrap(
                                spacing: 8.0,
                                children: controller.options.map((sizeModel) {
                                  // Determine if this chip is selected
                                  bool isSelected = controller.getSize == sizeModel.value;

                                  return GestureDetector(
                                    onTap: () {
                                      controller.setSize(sizeModel.value);
                                    },
                                    child: Container(
                                      padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                                      decoration: BoxDecoration(
                                        color: isSelected ? AppColor.bottomitemColor2 : Colors.white, // Selected color or white
                                        border: Border.all(color: isSelected ? Colors.transparent : AppColor.bottomitemColor2), // Blue border when unselected
                                        borderRadius: BorderRadius.circular(16),
                                      ),
                                      child: Text(
                                        sizeModel.value,
                                        style: TextStyle(
                                          color: isSelected ? Colors.white : AppColor.bottomitemColor2, // Text color based on selection
                                        ),
                                      ),
                                    ),
                                  );
                        ...
                        child: cartController.status == "Loading"
                          ...
                          onTap: () {
                            ...
                            if (signinController.id.value.trim() !="null" && signinController.id.value.trim() !="") {
                              ...
                              cartItem.quantity.value = controller.product.value.quant.value;
                              cartController.saveToCart(cartItem,signinController.id.value,context);
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  controller.options.isEmpty ? CircularProgressIndicator():
                  DropdownButton<String>(
                    ...
                    items: controller.options
                      ...
                      return DropdownMenuItem<
                        ...
                        child: Text(entry.value.toString()), // Custom label
                      );
                    }).toList(),
                  ),
                ],
              ...
              SizedBox(height: 20),
                ...
                onTap: () {
                  ...
                  if (signinController.id.value.trim() !=
                    ...
                    cartItem.color =
                        controller.selectedColor.value;
                    cartItem.tax = double.parse(controller
                        .product.value.tax
                        .toString());
                ...
                child:AppButton(buttonTitle: "Add To Cart")
                    .myButton,
              ),
