...
class Ecomcart extends StatefulWidget {
  @override
  State<Ecomcart> createState() => _EcomcartState();
}

class _EcomcartState extends State<Ecomcart> {
                                        ...
                                        ListTile(
                                                              ...
                                                              if (controller
                                                                ...
                                                                controller
                                                                    .cartItems[
                                                                        index]
                                                                    .quantity -= 1;
                                                                controller.addQuantityToCartTable(
                                                                    controller
                                                                            .cartItems[
                                                                        index],
                                                                    1,
                                          ...
                                          title: Wrap(children: [
                                            Text(controller.cartItems[index]
                                                .product!.name!),
                                            controller.cartItems[index].type !=
                                                    "school"
                                                ? Container()
                                                : Text(controller
                                                            .cartItems[index]
                                                        ...
                                                        "null"
                                                    ? ''
                                                    : ' ( ${controller.cartItems[index].size.toString()} )'),
                                          ]),
                                          subtitle: Wrap(
                                            children: [
                                              // Text(controller.cartItems[index]
                ...
                : Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Get.offAndToNamed(MyPagesName.dashBoard);
                          },
                          child: Container(
                              width: 150,
                              child:
