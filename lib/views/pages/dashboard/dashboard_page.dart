...
import 'package:Susani/views/pages/search_new/search_new_page.dart';
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        ...
        child: Scaffold(
          body: UpgradeAlert(
            upgrader: Upgrader(durationUntilAlertAgain: Duration(seconds: 5)),
            showIgnore: false,
            showLater: false,
          ...
          bottomNavigationBar: Obx(
            () => MyCircularBottomNavigation(
              tabItems: [
                ...
                TabItem(
                    'assets/icon/search.png', "", AppColor.bottomitemColor1),
